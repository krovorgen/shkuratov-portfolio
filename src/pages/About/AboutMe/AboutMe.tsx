    ...
    <>
          ...
          <div className={styles.info}>
            ...
            <div className={styles.text}>
              ...
              <p>
                ...
                метрики, провожу качественные и&nbsp;количественные исследования. На&nbsp;основе этих иследований
                принимаю интерфейсные решения.
              </p>
      ...
      <section className={styles.resume}>
        <div className="container">
          <p className={styles.resumeText}>Резюме в pdf формате можно посмотреть кликнув по ссылке ниже :) </p>
          <a className={styles.resumeLink} href="/Резюме.pdf" target="_blank" rel="noopener">
            <svg>
              <use xlinkHref={`./images/sprite.svg#launch`} />
            </svg>
            Смотреть резюме
          </a>
        </div>
