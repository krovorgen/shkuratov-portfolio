      ...
      <main className={cn('main', styles.main)}>
        ...
        <div className="container">
          ...
          <div className={cn(styles.content, styles['mb160-64'])}>
            <div className={styles.text}>
              ...
              <p>
                Для этого я&nbsp;составил карту на&nbsp;которой показал какой функционал блокирует разные разделы
                сервиса. С&nbsp;готовой дизайн-системой это позволит каждый раздел отдавать в&nbsp;работу
                по&nbsp;готовности, без необходимости ждать весь дизайн.
              </p>
            </div>
          </div>
          <div className={cn(styles.img, styles['mb160-64'])}>
        ...
        <div className="container">
          <div className={cn(styles['content--520'], styles['mb160-64'])}>
            ...
            <div className={styles.text}>
              <p>
                ...
                макетов. Основная логика, тексты и&nbsp;структуру я&nbsp;уже сделал. Оформляю прототипы
                в&nbsp;завершенный продукт и&nbsp;по&nbsp;готовности сразу отдаю команде.
              </p>
              <p>
                Первым делом авторизация и&nbsp;регистрация. Её&nbsp;ничего не&nbsp;блокировало. Разработчикам было
                удобно начинать именно с&nbsp;неё.
              </p>
            </div>
          </div>
          ...
          <div className={cn(styles.content, styles['mb128-44'])}>
            <div className={styles.text}>
              <p>
                Списки контактов. Первый раздел в&nbsp;пользовательской истории. Вначале надо добавить базу номеров,
                чтобы было кого обзванивать.
              </p>
            </div>
          </div>
          <div className={cn(styles.img, styles['mb160-64'])}>
          ...
          <div className={cn(styles['content--555'], styles['mb160-64'])}>
            <div className={styles.text}>
              <p>
                Дальше самое интересное&nbsp;&mdash; создание сценария звонка. Сделать удобный конструктор скриптов
                звонка была не&nbsp;тривиальная задача, но&nbsp;вместе с&nbsp;пользователями у&nbsp;меня получилось
          ...
          <h2 className={cn(styles.subtitle, styles['mb160-64'])}>
            ...
            пользовательские истории и&nbsp;функционал тестировались на&nbsp;этапе прототипов, поэтому критических
            проблем с&nbsp;юзабилити не&nbsp;было.
          </h2>
